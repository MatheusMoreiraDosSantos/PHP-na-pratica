...
include('conexao.php');
  ...
  var_dump($_POST);
 $manobra5 = $_POST['manobra5'];   // dados por post
 $fmanobra5= floatval($manobra5);  //converte em float
   
 $penalidade5 = $_POST['penalidade5'];   // dados por post
 $fpenalidade5 = floatval($penalidade5);  //converte em float
